...
if (nomepage2 != undefined) {
    ...
    function funcaoatualizardados() {
        ...
        names.innerHTML += `<form>
                            ...
                            <input type="button" value="Trocar" id="trocarsenha">
                            </form>`
    ...
    teste = document.querySelector(".testarusuario")
    teste.addEventListener("click", funcaotestar)
    ...
    function funcaotestar() {
        ...
        names.innerHTML += `<br><br><form>
                        ...
                        <input type = "button" id="botaotestar" value="Testar Usuário e Senha">
                        </form>`

        function funcaotestar2() {

            let usuariotest = document.querySelector("#usertestar").value
            let senhatest = document.querySelector("#senhatestar").value
            ...
            for (let index = 0; index < usuarios.length; index++) {
                if (usuarios[index].nome == usuariotest) {
